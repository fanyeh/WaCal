...
{
    NSString *urlWithParams = [NSString stringWithFormat:@"https://api-content.dropbox.com/1/files_put/dropbox/%@/byteclub_pano_%i.png",appFolder,arc4random() % 1000];
    NSURL *url = [NSURL URLWithString:urlWithParams];
    return url;
}
